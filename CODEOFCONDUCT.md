...
![Contributors](https://img.shields.io/github/contributors/K-Tanish/symptom-assist?style=for-the-badge) 
...
This Code of Conduct is adapted from the [Contributor Covenant (v3.0)](https://www.contributor-covenant.org/version/3/0/code_of_conduct/), with modifications tailored for **symptom-assist under the Nexus Spring of Code (NSoC’26)**.  
...
We thank every contributor, maintainer, and member for **making symptom-assist a safe, inclusive, and inspiring space.** ✨💡  
...
Let’s make **symptom-assist** a place where everyone feels welcome to **learn, contribute, and innovate.** 🍰🤖💡 
